...
/* ============================================================
   SEASONAL THEME DATES
   ============================================================
   Controls the small festive touches that appear site-wide for
   Vesak/Poson, Sinhala & Tamil New Year, and Christmas.

   - Christmas and Avurudu dates are stable year to year, so they're
     left as-is below.
   - Vesak & Poson Poya fall on different calendar dates every year
     (they follow the lunar calendar), so update the dates below
     once a year. Just search "Vesak Poya day Sri Lanka <year>" or
     "Poson Poya day Sri Lanka <year>" and update the month/day.

   Format: { month, day } — month is 1-12. "span" is how many days
   on either side of that date the effect should run for (so the
   theme doesn't just appear for a single day and vanish).
   ============================================================ */
const SEASONAL_DATES = {
  vesak:   { month: 5,  day: 30, span: 3 },   // Vesak Poya 2026 confirmed: May 30 — UPDATE YEARLY
  poson:   { month: 6,  day: 29, span: 2 },   // Poson Poya 2026 confirmed: June 29 — UPDATE YEARLY
  avurudu: { month: 4,  day: 14, span: 3 },   // Sinhala & Tamil New Year (2026: Apr 14)
  christmas: { month: 12, day: 25, span: 7 }  // Christmas season
};
